...
<div bind:this={tooltip} class="bg-base-200 rounded-md absolute z-0 p-2 transition-opacity select-none" class:opacity-0={!$RegionTooltipStore.delayElapsed || !$RegionTooltipStore.inRegions} style="top:{top}px; left:{left}px;">
    <p>{$RegionTooltipStore.content}</p>
</div>